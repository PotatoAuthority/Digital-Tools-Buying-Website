            ...
            <div className='flex flex-col md:flex-row gap-10 lg:gap-15 items-center justify-between'>
                <div className="left md:max-w-[53%]">
                    ...
                    <div>
                        ...
                        <p className='text-[#627382] text-[14px] md:text-[18px] leading-5 mt-4 text-center md:text-left'>Access premium AI tools, design assets, templates, and productivity software—all in one place. Start creating faster today. Explore Products</p>
                        
                    </div>
                    <div className='flex gap-4 mt-2 lg:mt-8'>
                        <button className="text-white btn bg-gradient-to-r from-[#4F39F6] to-[#9514FA] rounded-full hidden md:flex inter font-semibold text-[16px]">Explore Products</button>

                        <button className="bg-gradient-to-r from-[#4F39F6] to-[#9514FA] bg-clip-text text-transparent btn rounded-full hidden md:flex inter font-semibold text-[16px] border-[#9514FA]">
                            <img src={PlayImg} alt="" />
                            Watch Demo</button>
                    </div>
                </div>

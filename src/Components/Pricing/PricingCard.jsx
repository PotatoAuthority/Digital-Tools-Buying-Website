...
const PricingCard = ({priceInfo}) => {
    return (
        <div className={
            ...
            `flex flex-col justify-between p-6 rounded-2xl shadow-sm gap-6 bg-gradient-to-r from-[#4F39F6] to-[#9514FA] relative`
            :
            `border flex flex-col justify-between p-6 rounded-2xl shadow-sm gap-6 bg-[#F9FAFC] border-[#F2F2F2] border-2 relative`
            }>
            {
                priceInfo.popular===true?
            ...
            <div className='flex flex-col text-left'>
                <h1 className={`text-2xl font-bold mb-2 ${priceInfo.popular===true? 'text-white': ''}`}>{priceInfo.name}</h1>
            ...
            <button className={
                priceInfo.popular===true?
                `text-[#9514FA] w-full btn bg-white rounded-full inter font-semibold text-[16px] h-13`
                :
                `text-white w-full btn bg-gradient-to-r from-[#4F39F6] to-[#9514FA] rounded-full inter font-semibold text-[16px] h-13`

            }>{priceInfo.cta}</button>
        </div>
    );
};
